...
void WTN6_PlayOneByte(uint8_t val);//播放一个地址
uint8_t WTN6_PlayArray(uint8_t arrlen, uint8_t *soundarr);//播放一组地址（联播）
uint8_t WTN6_PlayArray_1(uint8_t arrlen, uint8_t *soundarr);//播放一组地址（联播）
#endif
